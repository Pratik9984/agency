          ...
          >
            ...
            <div className="flex flex-col divide-y divide-stone-200/80 w-full mt-4">
              ...
              <a href="https://wa.me/918421526195" target="_blank" rel="noopener noreferrer" className="py-4 flex items-center justify-between group transition-all duration-200">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-emerald-500/5 text-stone-550 flex items-center justify-center shrink-0 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 text-left">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <input
                            required id="phone" type="tel" value={formData.phone}
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[10px] font-bold uppercase tracking-wider text-stone-500" htmlFor="email">
                          Email Address <span className="text-stone-400 font-normal lowercase tracking-normal">(optional)</span>
                        </label>
                        <input
