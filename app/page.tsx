                ...
                >
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col justify-center items-start">
                    <div className="flex items-center gap-2.5 mb-2.5 flex-wrap">
                      <span className="text-blue-600 font-mono text-[9px] uppercase tracking-wider font-semibold">{project.label}</span>
                      <span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse" />
                      <span className="text-[9px] font-mono text-amber-600 uppercase font-medium bg-amber-500/5 px-2 py-0.5 rounded border border-amber-500/10">Prototype / In Development</span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                      ...
                      {project.liveUrl && (
                        ...
                        >
                          View Live Site
                          <svg className="w-3.5 h-3.5 stroke-current stroke-2" fill="none" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        </a>
                      )}
                      <div className="flex flex-wrap gap-1.5 text-[9px] font-mono text-stone-600">
